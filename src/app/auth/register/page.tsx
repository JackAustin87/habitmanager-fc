      ...
      <div className="w-full max-w-sm">
        <div className="bg-[#2d3748] border border-gray-600 rounded shadow-xl overflow-hidden">
          <div className="bg-blue-800 px-4 py-2.5">
            ...
            <p className="text-blue-300 text-xs">Sign Your Contract</p>
          </div>
          <div className="p-6 space-y-4">
            <p className="text-gray-400 text-xs">
              Register as manager. Your Face ID is your contract with the club.
            </p>
            <div>
            ...
            <p className="text-center text-xs text-gray-500">
              Already registered?{' '}
              <a href="/auth/login" className="text-fm-gold hover:underline">
                Sign in here
              </a>
            </p>
          </div>
